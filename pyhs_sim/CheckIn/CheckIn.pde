...
>>>>>>> 895844309b996ce4db4ecd45bd293c8f3430ef8f
  ...
  for(int i = 0; i < NUMH -1; i ++){
    for(int j = 0; j < NUMW -1; j++){
      ...
      /*
      p[i][j].addDrag(faero1);
      
      p[i][j+1].addDrag(faero1);
      p[i][j+1].addDrag(faero2);
      
      p[i+1][j].addDrag(faero1);
      p[i+1][j].addDrag(faero2);      

      p[i+1][j+1].addDrag(faero2);
      */
      /*
      p[i][j].subDrag(faero1);
      
      p[i][j+1].subDrag(faero1);
      p[i][j+1].subDrag(faero2);
      
      p[i+1][j].subDrag(faero1);
      p[i+1][j].subDrag(faero2);      

      p[i+1][j+1].subDrag(faero2);
      */
    }
  }
